## RF MODEL TUNING: PERCENT FINES Difference####
...
# klamath pred_obs data for testing on all post-fire sites
...
## Create Modeling Dataset for the Klamath ####
...
trees_split <- initial_split(difference_train.fines.k)
